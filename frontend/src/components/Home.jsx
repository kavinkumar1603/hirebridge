                ...
                <div className="w-full max-w-md animate-fade-in [animation-delay:200ms]">
                    ...
                    <div className="space-y-6 lg:space-y-8">
                        ...
                        <div>
                            ...
                            <div className="group cursor-pointer rounded-2xl border-2 border-dashed border-white/5 bg-white/[0.02] p-6 transition-all hover:bg-white/[0.04] hover:border-white/10">
